<div>
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Staff Menu Management</h1>
                <p class="text-gray-600 mt-2">Manage all canteen menu items</p>
            </div>
            <button
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <div class="p-6">
                    ...
                    <form wire:submit.prevent="saveMeal">
                        ...
                        <!-- Nutritional Info -->
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Nutritional Information (JSON)</label>
                            <textarea
                                wire:model="nutritional_info"
                                rows="2"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                placeholder='{"calories": 500, "protein": "25g", "carbs": "60g"}'
                            ></textarea>
                            @error('nutritional_info') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
